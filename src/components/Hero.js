                ...
                <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                    ...
                    <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                        ...
                        <div className="mt-10 flex items-center gap-x-4">
                            <Link to="/reservations" className="rounded-md bg-forest-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-forest-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-forest-600">Reserve a Table</Link>
