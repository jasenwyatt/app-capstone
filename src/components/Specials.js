...
export default class Specials extends Component {
    render() {
        return (
            <section className="bg-forest-500 py-8 sm:py-10">
                <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="text-lg font-semibold leading-8 tracking-tight text-forest-200">Specials</h2>
                    <p className="mt-2 max-w-lg text-pretty text-4xl font-semibold font-serif tracking-tight text-[#edefee] sm:text-5xl">Check out our fresh deals</p>
